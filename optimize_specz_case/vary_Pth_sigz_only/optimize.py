...
def run(eco, sigmacz, Pth, blos=1.1):
    eco.loc[:,'czerr'] = eco.loc[:,'cz']*0 + sigmacz
    ...
    eco.to_csv(f"eco_Pth{Pth}_sigmacz{sigmacz}.csv",index=False)
